...
namespace GameFramework.Fsm
{
    ...
    public sealed class Fsm<T> : FsmBase, ITypePoolObject, IFsm<T> where T : class
    {
        private T m_Owner;
        ...
        public static Fsm<T> Create(string name, T owner, params FsmState<T>[] states)
        {
            ...
            Fsm<T> fsm = TypePool.root.Get<Fsm<T>>();
            fsm.Name = name;
            fsm.m_Owner = owner;
        ...
        public void Clear()
        {
            ...
            if (m_Datas != null)
            {
                foreach (KeyValuePair<string, Variable> data in m_Datas)
                {
                    ...
                    TypePool.root.Return(data.Value);
                }
